...
- **[Source and decompile](#source-and-decompile)** (21 tools)
...
- **[Architecture and xrefs](#architecture-and-xrefs)** (20 tools)
...
**Enhancement:** Made tool listing session-aware so it reflects bootstrap visibility and enabled tool groups.
...
**Attribution:** Enhanced
**Enhancement:** Expanded namespace and type counts to include nested types recursively.
...
**Attribution:** Enhanced
**Enhancement:** Enumeration now includes nested types recursively instead of only top-level types.
...
**Attribution:** Enhanced
**Enhancement:** Added broader pattern matching and recursive nested-type search using a UI-safe assembly snapshot.
...
**Attribution:** Enhanced
**Enhancement:** Added explicit encoding selection and clearer file-path-based disambiguation for duplicate loaded assemblies.
...
**Attribution:** Enhanced
**Enhancement:** Accepts `obfuscator_type` as an alias when selecting the deobfuscation method.
...
**Attribution:** Enhanced
**Enhancement:** Added stable breakpoint IDs alongside list indices.
...
**Attribution:** Enhanced
**Enhancement:** `output_path` can now be omitted and is auto-generated next to the input executable.
...
**Attribution:** Enhanced
**Enhancement:** Normalized close responses to a consistent English-facing output surface.
...
**Attribution:** Enhanced
**Enhancement:** Normalized dialog inventory output to a consistent English-facing format.
